...
- **交付节奏** — 端到端研发周期实测**缩短 30%–40%**，源于样板代码与重复劳动被系统性消化。
...
### 🧠 [`mcp-sdk`](https://github.com/ArchAIHarness/mcp-sdk) — 神经

**AI 架构 MCP 通信套件**

打通 framework 与 AI Agent 的上下文协议。让 AI 不再"瞎猜"，而是**结构化理解**你的领域参数、租户语义与业务上下文。

<br/>

### ⚡ [`skill-market`](https://github.com/ArchAIHarness/skill-market) — 能力
